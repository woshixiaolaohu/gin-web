...
type GeneralDB struct {
	...
	MaxIdleConn int    `json:"max_idle_conn" yaml:"max_idle_conn" mapStructure:"max_idle_conn"` //空闲中的最大连接数
	MaxOpenConn int    `json:"max_open_conn" yaml:"max_open_conn" mapStructure:"max_open_conn"` //打开到数据库的最大连接数
