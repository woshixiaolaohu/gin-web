...
const docTemplate = `{
    ...
    "paths": {
        ...
        "/sysDictionary/getSysDictionary": {
            "get": {
                "security": [
                    {
                        "ApiKeyAuth": []
        ...
        "/sysDictionaryDetail/getSysDictionaryDetail": {
            "get": {
                "security": [
                    {
                        "ApiKeyAuth": []
        ...
        "/sysExportTemplate/getSysExportTemplate": {
            "get": {
                "security": [
                    {
                        "ApiKeyAuth": []
    ...
    "definitions": {
        ...
        "config.Captcha": {
            ...
            "properties": {
                ...
                "open_captcha": {
                    "description": "防爆验证码开启次数 0代表每次登录都需要验证码 其他数字代表错误密码次数 例3代表错误3次之后出现验证码",
                    "type": "integer"
                },
                "open_captcha_time_out": {
                    "description": "防爆验证码超时时间 单位 s(秒)",
                    "type": "integer"
                }
            }
        },
        ...
        "config.Mssql": {
            ...
            "properties": {
                ...
                "log_mode": {
                    "description": "是否打开Gorm全局日志",
                    "type": "string"
                },
                "log_zap": {
                    "description": "是否通过zap写入文件",
                    "type": "boolean"
                },
                "max_idle_conns": {
                ...
                "singular": {
                    "description": "是否开始全局禁用复数，true表示开启",
                    "type": "boolean"
                },
                "user_name": {
                    "description": "数据库用户名",
        ...
        "config.Redis": {
            ...
            "properties": {
                ...
                "db": {
                    "description": "单实例模式下 redis 使用那个数据库",
                    "type": "integer"
                },
                "password": {
                    "description": "密码",
        ...
        "config.Server": {
            ...
            "properties": {
                ...
                "db_list": {
                    "type": "array",
                    "items": {
                        "$ref": "#/definitions/config.SpecializeDB"
                    }
                },
                "disk_list": {
                    "type": "array",
                ...
                "email": {
                    "$ref": "#/definitions/gin-vue-admin_config.Email"
                },
                "huawei_obs": {
        ...
        "config.System": {
            ...
            "properties": {
                ...
                "dbType": {
                    "description": "数据库类型，默认mysql，可选(sqlite|sqlserver|postgresql)",
                    "type": "string"
                },
                "limit_count_ip": {
                    "type": "integer"
        ...
        "gin-vue-admin_config.Email": {
            ...
            "properties": {
                ...
                "port": {
                    "description": "端口 smtp协议端口 大部分为465",
                    "type": "integer"
                },
                "secret": {
                    "description": "密钥 邮箱smtp申请用于登录的密钥",
                    "type": "string"
                },
                "to": {
                    "description": "收件人：多个英文逗号隔开",
                    "type": "string"
                }
            }
        },
