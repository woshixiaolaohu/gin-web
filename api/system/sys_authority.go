...
func (a *AuthorityApi) CreateAuthority(c *gin.Context) {
	...
	response.OkWithDetailed(systemRes.SysAuthorityCopyResponse{Authority: authBack}, "创建成功", c)
}
...
func (a *AuthorityApi) CopyAuthority(c *gin.Context) {
	...
	err = utils.Verify(copyInfo, utils.AuthorityVerify)
	if err != nil {
		response.FailWithMessage(err.Error(), c)
		return
	}
